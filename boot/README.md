...
See the [Wi-Fi](https://www.qnx.com/developers/docs/qnxeverywhere/com.qnx.doc.target_images/topic/qsti/install.html#wi-fi)
section of the Quick start image target guide for more details on how to
populate the file.
