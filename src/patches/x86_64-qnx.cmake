...
set(CMAKE_FIND_ROOT_PATH "${CMAKE_SYSROOT};${CMAKE_SYSROOT}/x86_64")
...
# TODO: re-enable later when we need to build using CMake with apk dependencies
#set(ENV{PKG_CONFIG_LIBDIR} "${CMAKE_INSTALL_PREFIX}/usr/lib/pkgconfig")
