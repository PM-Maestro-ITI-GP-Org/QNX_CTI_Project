...
FT_00_LB=_Compile
FT_00_CM=clang -Wall -c "%f"
FT_00_WD=
FT_01_LB=_Build
FT_01_CM=clang -Wall -o "%e" "%f"
FT_01_WD=
FT_02_LB=_Lint
FT_02_CM=clang-tidy --checks=clang-analyzer-core.uninitialized.UndefValue,clang-analyzer-core.NullDereference --fix %f
FT_02_WD=
EX_00_LB=_Execute
EX_00_CM="./%e"
EX_00_WD=
